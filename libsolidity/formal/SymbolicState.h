...
public:
	...
	smtutil::Expression sysblockhash(smtutil::Expression _blockNumber) const;
	//@}
...
private:
	...
	BlockchainVariable m_tx{
		"tx",
		{
			...
			{"sysblockhash", std::make_shared<smtutil::ArraySort>(smtutil::SortProvider::uintSort, smtutil::SortProvider::uintSort)},
			// TODO gasleft
